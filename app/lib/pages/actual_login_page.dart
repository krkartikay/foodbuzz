...
class ActualLoginPage extends StatefulWidget {
  ...
  ActualLoginPage({Key key, this.login, this.register}) : super(key: key);

  final Function login;
  final Function register;

  @override
  _ActualLoginPageState createState() => new _ActualLoginPageState();
}
...
class _ActualLoginPageState extends State<ActualLoginPage>
  ...
  void _signIn() {
    ...
    widget.login(email, pass).then((_){
      print("here");
      Navigator.of(context).pop();
    }).catchError((e){
  ...
  void _signUp() {
    ...
    widget.register(email, pass).then((_) {
      Navigator.of(context).pop();
    }).catchError((e) {
      showInSnackBar(e);
    });
